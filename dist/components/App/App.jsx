...
const MovieDetails = (0, react_1.lazy)(() => Promise.resolve().then(() => __importStar(require('pages/MovieDetails/MovieDetails'))));
const Movies = (0, react_1.lazy)(() => Promise.resolve().then(() => __importStar(require('pages/Movies/Movies'))));
const Cast = (0, react_1.lazy)(() => Promise.resolve().then(() => __importStar(require('components/Cast/Cast'))));
const Reviews = (0, react_1.lazy)(() => Promise.resolve().then(() => __importStar(require('components/Reviews/Reviews'))));
const App = () => {
